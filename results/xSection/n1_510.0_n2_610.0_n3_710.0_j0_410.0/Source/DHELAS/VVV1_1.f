...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(OM1*P1(0)*(TMP8*(-CI*(TMP10)+CI*(TMP9))+(-CI*(TMP5
     $ *TMP6)+CI*(TMP4*TMP7)))+(TMP8*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(
     $ -CI*(TMP4)+CI*(TMP6))+V3(3)*(-CI*(TMP7)+CI*(TMP5)))))
      V1(4)= DENOM*(OM1*P1(1)*(TMP8*(-CI*(TMP10)+CI*(TMP9))+(-CI*(TMP5
     $ *TMP6)+CI*(TMP4*TMP7)))+(TMP8*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(
     $ -CI*(TMP4)+CI*(TMP6))+V3(4)*(-CI*(TMP7)+CI*(TMP5)))))
      V1(5)= DENOM*(OM1*P1(2)*(TMP8*(-CI*(TMP10)+CI*(TMP9))+(-CI*(TMP5
     $ *TMP6)+CI*(TMP4*TMP7)))+(TMP8*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(
     $ -CI*(TMP4)+CI*(TMP6))+V3(5)*(-CI*(TMP7)+CI*(TMP5)))))
      V1(6)= DENOM*(OM1*P1(3)*(TMP8*(-CI*(TMP10)+CI*(TMP9))+(-CI*(TMP5
     $ *TMP6)+CI*(TMP4*TMP7)))+(TMP8*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(
     $ -CI*(TMP4)+CI*(TMP6))+V3(6)*(-CI*(TMP7)+CI*(TMP5)))))
      END
