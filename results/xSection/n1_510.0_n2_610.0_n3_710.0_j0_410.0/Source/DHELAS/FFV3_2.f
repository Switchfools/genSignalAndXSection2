...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV3_5_2(F1, V3, COUP1, COUP2, M2, W2,F2)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(6)
      ...
      COMPLEX*16 COUP1
      INTEGER*4 I
      CALL FFV3_2(F1,V3,COUP1,M2,W2,F2)
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV3_7_2(F1, V3, COUP1, COUP2, M2, W2,F2)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(6)
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE FFV3_4_2(F1, V3, COUP1, COUP2, M2, W2,F2)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(6)
