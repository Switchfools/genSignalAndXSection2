...
V_113 = Vertex(name = 'V_113',
               ...
               couplings = {(0,0):C.GC_39,(0,1):C.GC_37})

V_114 = Vertex(name = 'V_114',
               particles = [ P.Ax, P.Ax, P.Ax, P.Ax ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_19})

V_115 = Vertex(name = 'V_115',
               particles = [ P.Ax, P.Ax, P.J0, P.J0 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_18})

V_116 = Vertex(name = 'V_116',
               particles = [ P.J0, P.J0, P.J0, P.J0 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_19})

V_117 = Vertex(name = 'V_117',
               particles = [ P.Ax, P.Ax, P.Ax ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_85})

V_118 = Vertex(name = 'V_118',
               particles = [ P.Ax, P.J0, P.J0 ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
               couplings = {(0,0):C.GC_84})

V_119 = Vertex(name = 'V_119',
               particles = [ P.N1, P.N1, P.J0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_81})

V_120 = Vertex(name = 'V_120',
               particles = [ P.N2, P.N2, P.J0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_82})

V_121 = Vertex(name = 'V_121',
               particles = [ P.N3, P.N3, P.J0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
